...
if uploaded_file:
    ...
    if st.button("PROSES"):
        ...
        if rules.empty:
            ...
            rules[["antecedent support", "consequent support", "support", "confidence"]] = rules[["antecedent support", "consequent support", "support", "confidence"]].applymap(lambda x: "{:.3f}%".format(x * 100))
            ...
            frq_items[["support"]] = frq_items[["support"]].applymap(lambda x: "{:.3f}%".format(x * 100))
